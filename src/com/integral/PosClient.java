...
//		Integer type=1;
		...
		//以下是发送的消息内容，用|分割按文档里定义的顺序发  18651652611
		//String cmdBody = "0010|400|100|300|200|100|18951652611|100|1";
		
		String cmdBody = "0010|400|100|300|18012985079|200|达伟|1";
	...
	void connect(String ip, String port) throws Exception {
	...
	Map sendCmd(List<Byte> bytes) throws Exception {
