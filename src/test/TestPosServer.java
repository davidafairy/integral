...
@Controller
public class TestPosServer implements InitializingBean {
...
//	private String agentCode="34b06q8";
	...
	private void startPosServer(String hostName,Integer port) throws IOException {
		...
		System.out.println("Pos Server["+hostName+":"+port+"] 已启动......................");
	...
	public void starServer(ServerSocket server) throws IOException {
		...
		while (true) {
			...
			TestPosServerThread st = new TestPosServerThread(socket,integralDao);
			new Thread(st).start();
		}
	}
